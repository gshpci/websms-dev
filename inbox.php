...
<table class="rwd-table" style="width: 100%">
    <thead>
        <tr class="listtr">
            <th class="listtd" style="text-align: center; color: white;" width="15%" >Datetime</th>
            <th class="listtd" style="text-align: center; color: white;" width="25%">From</th>
            <th class="listtd" style="text-align: center; color: white;" width="35%">SMS</th>
            <th class="listtd" style="text-align: left; color: white;" width="25%">Actions</th>
        </tr>
    </thead>
</table>
...
?>
    ...
    <td class = "listtd">
        ...
        ?>
                <button style="text-decoration:none;cursor:pointer; font-size: 10px;" class = "btn btn-success" data-toggle="modal" data-target="#AddData1-<?php echo $uid; ?>" data-backdrop="static" data-keyboard="false"><span class="glyphicon glyphicon-pencil" aria-hidden="true" style = "color:#ffffff;"></span><font size="1em">Add to Phonebook</font></button >
        <?php } ?>
        </div>
    </td>
...
<script>
        $('#AddData1-'+<?php echo $uid; ?>).draggable({
            handle: ".modal-header"
        });
...
/*
    ...
    function refreshTable(){
        $('#myDIV').load('inboxtable.php', function(){
